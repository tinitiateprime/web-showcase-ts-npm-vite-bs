...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Github, Chrome, Sparkles, User, Shield, Zap } from 'lucide-react';
            ...
            >
              ...
              <div className="card-body p-4">
                ...
                <div className="d-flex mb-4 p-1 bg-secondary bg-opacity-20 rounded-pill">
                  <button
                    className={`btn btn-sm flex-fill py-2 rounded-pill border-0 ${
                      isLogin ? 'text-white' : 'text-muted'
                    }`}
                    style={{
                      background: isLogin ? currentColors.gradient : 'transparent',
                ...
                <div>
                    ...
                    <div className="mb-3">
                      <div className="position-relative">
                        <User 
                          ...
                          style={{ 
                            color: activeInput === 'name' ? currentColors.primary : '#6c757d',
                  ...
                  <div className="mb-3">
                    <div className="position-relative">
                      <Mail 
                        ...
                        className="position-absolute top-50 start-0 translate-middle-y ms-3"
                        style={{ 
                          color: activeInput === 'email' ? currentColors.primary : '#6c757d',
                          transition: 'color 0.3s ease'
                        }}
                      />
                      <input
                  ...
                  <div className="mb-3">
                    <div className="position-relative">
                      <Lock 
                        ...
                        className="position-absolute top-50 start-0 translate-middle-y ms-3"
                        style={{ 
                          color: activeInput === 'password' ? currentColors.primary : '#6c757d',
                          transition: 'color 0.3s ease'
                        }}
                      />
                      <input
                  ...
                  <div className="text-center">
                    ...
                    <div className="d-flex gap-2">
                      <button
                        type="button"
                        className="btn btn-outline-secondary btn-sm flex-fill py-2 d-flex align-items-center justify-content-center gap-2"
                      >
