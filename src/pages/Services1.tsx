...
const Services1 = () => {
  ...
  const testimonials: Testimonial[] = [
    { name: "Sarah Johnson", company: "Tech Startup Inc.", text: "Amazing work! They delivered exactly what we needed.", rating: 5 },
    { name: "Michael Chen", company: "Digital Agency", text: "Professional team with excellent communication.", rating: 5 },
    { name: "Emma Davis", company: "E-commerce Store", text: "Our sales increased by 300% after the redesign!", rating: 5 },
  ];
    ...
    >
      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-transparent">
        <div className="container">
          ...
          <div className="navbar-nav ms-auto">
            ...
            <a href="/services" className="nav-link text-white fw-bold">
              Services
            </a>
      ...
      <div className="container py-5">
        <div className="text-center text-white mb-5">
          ...
          <p className="lead mb-4">Transforming ideas into digital reality with cutting-edge solutions</p>
                ...
                <div className="card-body p-4">
                  ...
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        alert(`Get Quote for: ${service.title}`);
                      }}
                    >
                      Get Quote
                    </button>
                  ...
                  {activeService === service.id && (
                    <div className="border-top pt-3 mt-3" style={{ animation: "slideDown 0.3s ease" }}>
                      <h6 className="fw-bold mb-2">Project Timeline:</h6>
                      <p className="small text-muted mb-2">📅 2-6 weeks depending on complexity</p>
      ...
      {/* CTA buttons hover (your previous error was e.target.style) */}
      <div className="container pb-5">
        <div
        ...
        >
          <div className="card-body p-5">
            ...
            <p className="lead text-muted mb-4">Let's discuss your project and bring your vision to life</p>
      ...
      <div className="text-center pb-4">
        <p className="text-white-50 small mb-0">© 2025 YourApp. Premium Digital Solutions</p>
      </div>

      {/* ✅ FIX: remove style jsx, use normal style */}
      <style>{`
        @keyframes slideDown {
