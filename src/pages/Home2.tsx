...
export default function HomePage() {
  ...
  const features = [
    { icon: <Code size={24} />, title: "TypeScript Ready", description: "Type-safe development experience" },
    { icon: <Zap size={24} />, title: "Lightning Fast", description: "Vite-powered instant builds" },
    { icon: <Layers size={24} />, title: "Modern Stack", description: "Bootstrap 5 + React hooks" },
  ];
        ...
        <div className="container text-center">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="mb-3">
                <Sparkles size={32} style={{ color: currentColors.primary, animation: "pulse 2s infinite" }} />
              </div>
              <h1
              ...
              <p className="mb-4 text-light opacity-75">Modern development with TypeScript, Vite & Bootstrap</p>
              ...
              <div key={index} className="col-lg-4">
                ...
                >
                  <div className="card-body p-2">
                    <div
                      className="mb-2"
                      style={{ color: activeFeature === index ? currentColors.primary : "#6c757d", transition: "color 0.5s ease" }}
                    >
                      {feature.icon}
                    </div>
          ...
          <div className="row g-3">
            {stats.map((stat, index) => (
              <div key={index} className="col-4 text-center">
                <h4 className="fw-bold mb-0" style={{ color: currentColors.primary, transition: "color 1s ease" }}>
                  {stat.number}
                </h4>
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
              ...
              <p className="text-muted mb-3 small">Get started with our optimized development setup</p>
              <div className="d-flex flex-wrap gap-2">
                <span className="badge bg-secondary">
                  <Star size={12} className="me-1" /> HMR
                </span>
                <span className="badge bg-secondary">
                  <Star size={12} className="me-1" /> TypeScript
                </span>
                <span className="badge bg-secondary">
                  <Star size={12} className="me-1" /> Bootstrap 5
                </span>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="bg-dark rounded-2 p-3 shadow">
                <div className="d-flex align-items-center mb-2">
                  <div className="bg-danger rounded-circle me-1" style={{ width: "8px", height: "8px" }} />
                  <div className="bg-warning rounded-circle me-1" style={{ width: "8px", height: "8px" }} />
                  <div className="bg-success rounded-circle me-1" style={{ width: "8px", height: "8px" }} />
...
🚀 Ready at localhost:3000`}</code>
      ...
      <section className="py-3" style={{ background: currentColors.gradient }}>
        <div className="container text-center">
          ...
          <p className="mb-3 opacity-90 small">Join developers building with our modern stack</p>
          <div className="d-flex gap-2 justify-content-center flex-wrap">
            <button className="btn btn-light btn-sm px-3 py-2">
              <ArrowRight size={14} className="me-1" /> Get Started
            </button>
            <button className="btn btn-outline-light btn-sm px-3 py-2">View Docs</button>
          </div>
        </div>
      </section>
