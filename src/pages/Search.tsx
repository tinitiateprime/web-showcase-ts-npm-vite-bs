...
type Category = "all" | "tutorial" | "design" | "technology" | "mobile";
...
const SearchPage = () => {
  ...
  const searchResults: SearchResult[] = [
    ...
    },
    {
      ...
      description:
        "Discover the latest trends in web design and how to create stunning user experiences.",
      category: "design",
      author: "Mike Chen",
      date: "2024-12-10",
      rating: 4.6,
    ...
    },
    {
      ...
      description:
        "Essential strategies for deploying and managing applications in the cloud.",
      category: "technology",
      author: "Emma Davis",
      date: "2024-12-08",
      rating: 4.9,
    ...
    },
    {
      ...
      description:
        "Advanced techniques for optimizing database performance and scalability.",
      category: "tutorial",
      author: "John Smith",
      date: "2024-12-01",
      rating: 4.8,
  ...
  const sortedResults = useMemo(() => {
    ...
    arr.sort((a, b) => {
      switch (sortBy) {
        case "date":
          return new Date(b.date).getTime() - new Date(a.date).getTime(); // ✅ FIX
        case "rating":
  ...
  return (
    ...
    >
      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-transparent">
        <div className="container">
          ...
          <div className="navbar-nav ms-auto">
            ...
            <a href="/search" className="nav-link text-white fw-bold">
              Search
            </a>
            <a href="/trending" className="nav-link text-white">
              Trending
            </a>
            <a href="/favorites" className="nav-link text-white">
              Favorites
            </a>
          </div>
        </div>
            ...
            >
              <div className="card-body p-5">
                ...
                <form onSubmit={handleSearch} className="mb-4">
                  <div className="input-group input-group-lg">
                    ...
                    <button
                      ...
                      onMouseEnter={(e) => {
                        // ✅ FIX: currentTarget is correctly typed
                ...
                <div className="text-center">
                  ...
                  {["React", "JavaScript", "Design", "AI", "Mobile"].map((tag) => (
                    <button
                      key={tag}
                      type="button"
          ...
          <div className="col-lg-9">
            ...
            {isSearching ? (
              ...
              <div className={viewMode === "grid" ? "row g-4" : ""}>
                {sortedResults.map((result) => (
                  <div
                    key={result.id}
                    className={viewMode === "grid" ? "col-md-6 col-lg-4" : "mb-4"}
                  >
                    <div
                    ...
                    >
                      <div className={`card-body p-4 ${viewMode === "list" ? "d-flex" : ""}`}>
                        ...
                        <div className="flex-grow-1">
                          ...
                          <p className="card-text text-muted mb-3">{result.description}</p>

                          <div className="d-flex justify-content-between align-items-center mb-3">
                            <small className="text-muted">👤 {result.author}</small>
            ...
            {!isSearching && sortedResults.length === 0 && (
              <div className="text-center py-5">
                ...
                <h3 className="text-white fw-bold mb-3">No results found</h3>
                <p className="text-white-50 mb-4">Try adjusting your search query or filters</p>
                <button
                  type="button"
      ...
      <div className="text-center pb-4">
        <p className="text-white-50 small mb-0">© 2025 SearchHub. Discover, Learn, Grow</p>
      </div>
    </div>
  );
};
